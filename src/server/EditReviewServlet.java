...
public class EditReviewServlet extends LoginBaseServlet{
    ...
    private void printForm(HttpServletRequest request,PrintWriter out) {
        ...
        out.println("<input required value =\""+reviewmap.get("rating")+"\"  placeholder=\"Enter your rating from 1-5...\" type=\"text\" name=\"rating\" size=\"50\"pattern=\"[0-5]{1}\"  title=\"- Must be a number between 1-5\">");
