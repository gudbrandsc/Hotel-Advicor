...
public class EditReviewServlet extends LoginBaseServlet{
    ...
    private void printForm(HttpServletRequest request,PrintWriter out) {
        ...
        out.println("<input value =\""+reviewmap.get("title")+"\" placeholder=\"Title\" type=\"text\" name=\"title\" size=\"50\">");
        out.println("<p style=\"text-align: center;\">Rating:</p>");
        out.println("<input value =\""+reviewmap.get("rating")+"\"  placeholder=\"Enter your rating from 1-6...\" type=\"text\" name=\"rating\" size=\"50\"pattern=\"[0-6]{1}\" autofocus required title=\"- Must be a number between 1-6\">");
